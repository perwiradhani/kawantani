...
if(isset($_POST['update'])){
    ...
    $query = "INSERT INTO penanaman (id, id_lahan, tgl_tanam, luas) 
    VALUES (NULL, '$id', '$tgl', '$luas')";
    $stmt = mysqli_query($db, $query);

    $query2 = "UPDATE lahan SET status = 'Tanam' WHERE id_lahan = '$id'";
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label for="first-name-column">Tanggal Tanam</label>
                                                        <input type="date" id="first-name-column" class="form-control" name="tgl">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label for="city-column">Luas Yang Ditanami</label>
